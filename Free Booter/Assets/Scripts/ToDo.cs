...
public class ToDo : MonoBehaviour
{
    ...
    REFACTOR SPAWNERS TO POOLS -- CHECK
    FIX SAILS BUG (SAIL DAMAGE AFFECTS PLAYER MOVE SPEED WAY TOO MUCH) -- CHECK
    IMPLIMENT FOG OF WAR
        EXPAND MAP -- CHECK
        IMPLIMENT FOG OF WAR IN EXTRA AREAS -- CHECK
        SUPRESS SHIP SPAWNING IN NEW AREAS UNTIL THEY ARE UNLOCKED -- CHECK
        UNLOCK EXPANDED AREAS WITH MAPS -- CHECK
        ADD WEATHER TO UNLOCKED AREAS -- CHECK
    TREASURE MAPS
        ADD TO ITEMDB -- CHECK
        ...
        ADD HIDDEN "HIDDEN TREASURE" SPOTS THROUGHOUT THE MAP -- CHECK
        UNLOCK SPECIFIC HIDDEN TREASURE SPOTS WHEN PLAYER HOLDS A MAP -- CHECK
        RANDOMIZE MAP LOCATIONS -- CHECK
        ADD TREASURE MAPS TO APPEAR RANDOMLY IN SHOPS -- MIGHT SAVE FOR LATER
    FIX MAIN MENU BUTTONS SO THAT THEY DON'T AUTOMATICALLY TRIGGER ON LOAD
    PUT ENEMY SHIPS BACK IN THE GAME -- CHECK
    BUG!!!
